...
export const templates: { [key: string]: Template } = {
    ...
    veoExtensionShowcase: {
        name: 'Veo 3.1 Extension Loop',
        description: 'Generate a core shot then extend it with additional action beats.',
        nodes: [
            {
                id: 'base_scene_prompt',
                type: NodeType.Text,
                position: { x: 40, y: 160 },
                data: {
                    text: 'A cybernetic courier leaps across rooftop billboards as neon drones close in, rain hammering the skyline.',
                },
            },
            {
                id: 'base_scene_video',
                ...
                data: {
                    ...
                    durationSeconds: 8,
                    referenceImageUrls: [],
                    editDescription: 'A cybernetic courier vaults across neon billboards, rain-lashed wind whipping their coat as drones swarm behind.',
                },
            },
            {
                id: 'extended_scene_video',
                type: NodeType.VideoGenerator,
                ...
                data: {
                    ...
                    durationSeconds: 7,
                    referenceImageUrls: [],
                    editDescription: 'Continue the chase with the courier sliding under signage, drones erupting in sparks, crowd gasps, and sirens swelling.',
                },
            },
        ],
        connections: [
            {
                id: 'conn_extension_prompt_seed',
                fromNodeId: 'base_scene_prompt',
                fromHandleId: 'text_output',
                toNodeId: 'base_scene_video',
                toHandleId: 'prompt_input',
            },
            {
                id: 'conn_extension_prompt_extend',
                fromNodeId: 'base_scene_prompt',
                fromHandleId: 'text_output',
                toNodeId: 'extended_scene_video',
                toHandleId: 'prompt_input',
            },
            {
                id: 'conn_extension_video_input',
                fromNodeId: 'base_scene_video',
                fromHandleId: 'video_output',
                toNodeId: 'extended_scene_video',
                toHandleId: 'video_input',
            },
        ],
    },
};
